...
const Section4 = () => {
  return (
    <section className="relative h-screen w-full flex items-center justify-end">
      ...
      {/* Content Container */}
      <div className="relative w-full md:w-[650px] mr-4 md:mr-20 lg:mr-32">
        <motion.div 
        ...
        >
          ...
          >
            Sind Sie bereit, das{" "}
            <span className="text-first">Catering</span> für Ihre{" "}
            <span className="text-first">Veranstaltung</span> zu buchen?
          </motion.h2>
          ...
          >
            Lassen Sie uns gemeinsam Ihre Veranstaltung zu einem kulinarischen Erlebnis machen
          </motion.p>
        </motion.div>
      </div>
    </section>
